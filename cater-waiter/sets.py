...
def tag_special_ingredients(dish):
    ...
    Return the dish name followed by the `set` of ingredients that
    require a special note on the dish description.
...
def compile_ingredients(dishes):
    ...
    return set(reduce(lambda a, b: a.union(b), dishes))
...
def singleton_ingredients(dishes, intersection):
    ...
    :param intersection: constant -
    one of (VEGAN_INTERSECTION,VEGETARIAN_INTERSECTION,PALEO_INTERSECTION,
    ...
    return set(reduce(lambda a, b: a.union(b), dishes)).difference(intersection)
